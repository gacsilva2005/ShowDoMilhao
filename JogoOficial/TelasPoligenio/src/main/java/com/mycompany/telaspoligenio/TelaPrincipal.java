...
public class TelaPrincipal extends JFrame {
    ...
    public TelaPrincipal(){
        ...
        try {
            PanelPrincipal telaPrincipalPanel = new PanelPrincipal();
            painelPrincipal.add(telaPrincipalPanel, "TelaPrincipal");
            add(painelPrincipal);
            cardLayout.show(painelPrincipal, "TelaPrincipal");
    ...
    public static class PanelPrincipal extends JPanel {
        ...
        private BufferedImage imagemDeFundoPrincipal;
        ...
        public PanelPrincipal() throws IOException {
            ...
            imagemDeFundoPrincipal = ImageIO.read(getClass().getResource("/ImagensTelaPrincipal/telaPrincipal.png"));
            imagemBotaoJogar = ImageIO.read(getClass().getResource("/ImagensTelaPrincipal/botaoJogar.png"));
            imagemBotaoConfig = ImageIO.read(getClass().getResource("/ImagensTelaPrincipal/botaoConfig.png"));
            imagemBoxCash = ImageIO.read(getClass().getResource("/ImagensTelaPrincipal/boxCash.png"));
        ...
        protected void paintComponent(Graphics g) {
            ...
            if (imagemDeFundoPrincipal != null) {
                g2d.drawImage(imagemDeFundoPrincipal, 0, 0, w, h, this);
            }
        }
    }
}
