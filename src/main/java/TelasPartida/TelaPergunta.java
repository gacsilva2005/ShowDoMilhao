         ...
         public PanelPergunta() throws IOException {
            ...
            JPanel painelConteudo = new JPanel(null) {
                ...
                protected void paintComponent(Graphics g) {
                    ...
                    int xAltA = centroX - (larguraBotAltA / 2);
                    int yAltA = (int) (h * 0.45) + 90; // 45% da altura da tela
                    int xAltB = centroX - (larguraBotAltB / 2);
                    int yAltB = yAltA + alturaBotAltA + (int)(50 * escala);
                    int xAltC = centroX - (larguraBotAltC / 2) - 540;
                    int yAltC = (int) (h * 0.45) + 90; // 45% da altura da tela
                    int xAltD = centroX - (larguraBotAltD / 2) - 540;
                    int yAltD = yAltC + alturaBotAltC + (int)(50 * escala);
